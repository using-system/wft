...
namespace WFT.Helpers.Scheduling
{
    ...
    internal sealed class CrontabSchedule
    {
        ...
        internal static CrontabSchedule Parse(string expression)
        {
            return TryParse(expression, ErrorHandling.Throw).Value;
        }

        internal static ValueOrError<CrontabSchedule> TryParse(string expression)
        {
        ...
        internal IEnumerable<DateTime> GetNextOccurrences(DateTime baseTime, DateTime endTime)
        {
        ...
        internal DateTime GetNextOccurrence(DateTime baseTime)
        {
        ...
        internal DateTime GetNextOccurrence(DateTime baseTime, DateTime endTime)
        {
            const int nil = -1;
