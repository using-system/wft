...
{
    internal delegate ExceptionProvider CrontabFieldAccumulator(int start, int end, int interval, ExceptionHandler onError);
    ...
    internal sealed class CrontabFieldImpl : IObjectReference
    {
        ...
        internal static CrontabFieldImpl FromKind(CrontabFieldKind kind)
        {
